...
class Graph(object):
    ...
    def dfs_helper(self, start_node):
        ...
        #     from_value = edge.node_from.value
        #     child_visited = edge.node_from.visited
        #     if (start_value == from_value) and not child_visited:
        #         unvisited_children.append(edge.node_from)
        # if len(unvisited_children) == 0:
        #     return ret_list
        # else :
        #     for children in unvisited_children:
        #         ret_list.append(self.dfs_helper(self, children))
        # return ret_list
